...
uvc_video_fill_buffer(struct uvc_device *dev, struct v4l2_buffer *buf)
{
	...
	struct v4l2_buffer v4l2_buf[1]; 

	memset(&v4l2_buf, 0, sizeof v4l2_buf);
	v4l2_buf[0].type = V4L2_BUF_TYPE_VIDEO_CAPTURE;	
	v4l2_buf[0].memory = V4L2_MEMORY_MMAP;  


	pthread_mutex_lock(&dev->v4l2->mutex);
	

    ret1 = ioctl(dev->fd_v4l2, VIDIOC_DQBUF, &v4l2_buf[0]);
    ret2 = ioctl(dev->fd_v4l2, VIDIOC_QBUF, &v4l2_buf[0]);
